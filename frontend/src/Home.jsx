...
export default function Home() {
  ...
  const handleDbClick = () => { sessionStorage.clear(); navigate('/session_storage'); }
    ...
    <div className="home-container" >
      ...
      <header className="header" >
        <div className="top-bar">
          ...
          <img src="/img/privacy-icon.png" alt="Storage" className={`bar-icon w-8 h-8 cursor-pointer ${currentLoc === "/session_storage" ? "dim-icon" : ""}`} onClick={handleDbClick} />
